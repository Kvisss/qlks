                                    ...
                                    <div class="middle-2-left-2 middle-2-left-1">
                                        ...
                                        <div class="middle-2-left-2-img">
                                            ...
                                            <div class="mySlides">
                                                ...
                                                <img src="../img/img-rooms/room-1/room-1.jpg" style="width:100%">
                                            </div>

                                            <div class="mySlides">
                                                <div class="numbertext">2 / 6</div>
                                                <img src="../img/img-rooms/room-1/room-2.jpg" style="width:100%">
                                            </div>

                                            <div class="mySlides">
                                                <div class="numbertext">3 / 6</div>
                                                <img src="../img/img-rooms/room-1/room-3.jpg" style="width:100%">
                                            </div>

                                            <div class="mySlides">
                                                <div class="numbertext">4 / 6</div>
                                                <img src="../img/img-rooms/room-1/room-4.jpg" style="width:100%">
                                            </div>

                                            <div class="mySlides">
                                                <div class="numbertext">5 / 6</div>
                                                <img src="../img/img-rooms/room-1/room-5.jpg" style="width:100%">
                                            </div>

                                            <div class="mySlides">
                                                <div class="numbertext">6 / 6</div>
                                                <img src="../img/img-rooms/room-1/room-6.jpg" style="width:100%">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="column">
                                                    <img class="demo cursor" src="../img/img-rooms/room-1/room-1.jpg" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
                                                </div>
                                                <div class="column">
                                                    <img class="demo cursor" src="../img/img-rooms/room-1/room-2.jpg" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
                                                </div>
                                                <div class="column">
                                                    <img class="demo cursor" src="../img/img-rooms/room-1/room-3.jpg" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
                                                </div>
                                                <div class="column">
                                                    <img class="demo cursor" src="../img/img-rooms/room-1/room-4.jpg" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
                                                </div>
                                                <div class="column">
                                                    <img class="demo cursor" src="../img/img-rooms/room-1/room-5.jpg" style="width:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
                                                </div>
                                                <div class="column">
                                                    <img class="demo cursor" src="../img/img-rooms/room-1/room-6.jpg" style="width:100%" onclick="currentSlide(6)" alt="Snowy Mountains">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="middle-2-right-1">
                                        ...
                                        <div class="dropdown-divider " style="margin: 0 "></div>
                                        <div class="row">
                                            <form action="/test" method="get" style="width:100%">
                                                ...
                                                <div class="col-12 middle-2-right-input">
                                                    <button name="" id="" class="btn btn-primary" role="button">Đăng nhập</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
